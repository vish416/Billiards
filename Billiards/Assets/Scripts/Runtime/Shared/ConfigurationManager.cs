    ...
    public class ConfigurationManager
    {
        ...
        void LoadConfigurationFromFile(string configFilePath, bool createIfNotExists, bool updateIfOutdated)
        {
            ...
            if (!File.Exists(configFilePath))
            {
                ...
                {
                    throw new FileNotFoundException($"{configFilePath} not found, please open the bootstrapper to create a default configuration file (menu Window > Multiplayer > Bootstrapper)");
                }
